...
export interface CursorGridProps {
  ...
  className?: string;
  style?: CSSProperties;
  /** When true, listens to window mouse/click events so canvas can be pointer-events:none */
...
export const CursorGrid: React.FC<CursorGridProps> = ({
  ...
  useEffect(() => {
    ...
    // Convert window-level coordinates to canvas-local
