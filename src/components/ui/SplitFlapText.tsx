...
const toCssUnit = (value?: number | string): string | undefined => {
...
const normalizePhrase = (phrase: string | undefined, width: number): string => {
...
export const SplitFlapText: React.FC<SplitFlapTextProps> = ({
  ...
  useEffect(() => {
    ...
    const animateTo = (targetPhrase: string): number => {
      ...
      const plans: AnimationPlan[] = targetChars
